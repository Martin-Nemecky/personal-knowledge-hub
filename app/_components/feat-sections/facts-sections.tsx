...
export default function FactsSection() {
	return (
		<div id="facts" className="w-full flex flex-col lg:flex-row bg-gray-100 shadow-inner px-20 py-2">
			...
			<div className="basis-1/2 flex justify-center">
				<div className="flex flex-col">
					<Image src="/facts.svg" width={700} height={700} alt="Picture of a information seeker" />
